...
export class App {
  constructor(container, options = {}) {
    ...
    const isDarkMode = options.colors.roadColor === 0x080808;
    ...
    if (isDarkMode) {
      ...
      this.scene.fog = null;
      // fogUniforms con niebla blanca muy lejana — los shaders necesitan estos valores
      this.fogUniforms = {
  ...
  initPasses(isDarkMode = true) {
    this.renderPass = new RenderPass(this.scene, this.camera);
    this.bloomPass = new EffectPass(
      this.camera,
      new BloomEffect({
        luminanceThreshold: isDarkMode ? 0.2 : 0.05,
  ...
  init(isDarkMode = true) {
    this.initPasses(isDarkMode);
